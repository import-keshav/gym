<html>
	<head>
    	...
    	<meta name="viewport" content="width=device-width, initial-scale=1">
  		...
  		<!-- My files -->
  		<link rel="stylesheet" href="http://localhost/gym/css/product_home.css">
  		<script src="http://localhost/gym/javascript/product_home.js"></script>
	...
	<body>
		<div class="container-fluid">
			<div class="row top-bar">
				...
				<div class="col-md-1">
					<nav class="navbar dropdown_display" style="margin-left: 30px;">
						<div>
							<ul class="nav navbar-nav">
								<li class="dropdown">
